...
struct StoryBrain {
    ...
    mutating func onNextStory(_ chosenOption: String) {
        if (chosenOption == stories[currentStoryNumber].choice1) {
            currentStoryNumber = stories[currentStoryNumber].choice1Destination
        } else {
